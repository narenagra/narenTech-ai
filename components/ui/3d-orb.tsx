...
export default function Globe() {
  ...
  useEffect(() => {
   ...
   `
    ...
    Promise.all([
      loadTexture("https://images.unsplash.com/photo-1614730321146-b6fa6a46bcb4?w=1024&auto=format&fit=crop&q=80"),
      loadTexture("https://images.unsplash.com/photo-1506703719100-a0f3a48c0f86?w=1024&auto=format&fit=crop&q=80"),
      loadTexture("https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=1024&auto=format&fit=crop&q=80"),
